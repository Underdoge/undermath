...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Undermath - Clase 5 Bootcamp Python Avanzado - Código Facilito 1.1.0 documentation")
)
